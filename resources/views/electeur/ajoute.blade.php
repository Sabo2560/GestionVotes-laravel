...
<div class="container text-center mt-4">
    ...
    @endif 
    <div class="card">
        <div class="card-header bg-info text-dark fw-bolder">Inscrivez-Vous Comme Electeur :</div>
        <div class="card-body bg-body-tertiary">
            <form action="{{ route('vote.electeur') }}" method="post">
                @csrf
                ...
                <div class="form-group d-grid mt-2">
                    <label for="" class="fw-bolder"> CNI :</label>
                    <input type="string" name="CNI" id="" class="form-control text-center fw-bolder" required>
                </div>

                <div class="d-grid col-6 mx-auto mt-5">
                    <button class="btn btn-outline-dark fw-bolder"><strong>VOTER</strong></button>
                </div>
            </form>
        </div>
    </div>
